...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(440, 10, 221, 191))
        ...
        self.open_camera.setGeometry(QtCore.QRect(50, 500, 93, 28))
        self.open_camera.setObjectName("open_camera")
        self.yolov3 = QtWidgets.QPushButton(Form)
        self.yolov3.setGeometry(QtCore.QRect(240, 500, 121, 28))
        self.yolov3.setObjectName("yolov3")
        self.close_camera = QtWidgets.QPushButton(Form)
        self.close_camera.setGeometry(QtCore.QRect(50, 540, 93, 28))
        self.close_camera.setObjectName("close_camera")
        self.close_yolov3 = QtWidgets.QPushButton(Form)
        self.close_yolov3.setGeometry(QtCore.QRect(240, 540, 121, 28))
        self.close_yolov3.setObjectName("close_yolov3")
        self.groupBox_3 = QtWidgets.QGroupBox(Form)
        self.groupBox_3.setGeometry(QtCore.QRect(440, 220, 221, 191))
        self.groupBox_3.setObjectName("groupBox_3")
        self.textBrowser_recv = QtWidgets.QTextEdit(self.groupBox_3)
        self.textBrowser_recv.setGeometry(QtCore.QRect(10, 20, 201, 161))
    ...
    def retranslateUi(self, Form):
        ...
        self.verticalGroupBox.setTitle(_translate("Form", "串口接收区"))
        ...
        self.groupBox_3.setTitle(_translate("Form", "网络接收区"))
